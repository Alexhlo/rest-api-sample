...
@ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "400", description = "Something wrong", content = @Content(schema = @Schema(implementation = ErrorMessage.class))),
        @ApiResponse(responseCode = "404", description = "Student wasn't found", content = @Content(schema = @Schema(implementation = ErrorMessage.class))),
        @ApiResponse(responseCode = "500", description = "Service error", content = @Content(schema = @Schema(implementation = ErrorMessage.class)))
})
